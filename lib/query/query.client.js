...
export default class Query extends Base {
    ...
    async fetchSync() {
        ...
        return await callWithPromise(this.name, prepareForProcess(this.collection, this.body, this.params));
    }
    ...
    async getCountSync() {
        ...
        return await callWithPromise(this.name + '.count', prepareForProcess(this.collection, this.body, this.params));
    }
    ...
    _fetchStatic(callback) {
        ...
        Meteor.call(this.name, prepareForProcess(this.collection, this.body, this.params), callback);
    }
    ...
    _fetchReactive(options = {}) {
        let body = prepareForProcess(this.collection, this.body, this.params);
